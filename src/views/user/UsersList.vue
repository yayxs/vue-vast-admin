<template>
  <div class="app-container">
    ...
    <el-row class="searchArea">
      <el-col :span="24">
        <el-input v-model="search" class="searchInput" clearable placeholder="请搜索您想要的内容">
    ...
    >
      ...
      <el-table-column label="用户头像" width="110" align="center">
        <template slot-scope="scope">
          <img
            :src="scope.row.avatar?`https://api.cat-shop.penkuoer.com/${scope.row.avatar}`:`http://www.gravatar.com/avatar/791c73d60b9a2f6fade8f72b78c635bf?s=200&r=pg&d=mm`"
            width="40"
            height="40"
